...
@Component({
	selector: 'app-homeliving-dashboard',
	templateUrl: './homeliving-dashboard.component.html',
	styleUrls: ['./homeliving-dashboard.component.scss']
})
export class HomelivingDashboardComponent implements OnInit {
